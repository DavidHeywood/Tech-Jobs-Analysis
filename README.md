...
## Data 
* Source: I accessed this data on Kaggle.  It was scraped from [levels.fyi]([levels.fyi](https://www.levels.fyi/?compare=Chevron,Travelers,Google&track=Software%20Engineer)) by Jack Ogozaly using the technique outlined in [this article](https://towardsdatascience.com/a-beginners-guide-to-grabbing-and-analyzing-salary-data-in-python-e8c60eab186e).  These data were scraped in 2021.
